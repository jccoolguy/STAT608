...
The first parameter $\alpha_1$ is the expected value of the first group, so it should be the mean of the response variables with $x_1=1$. The second parameter $\alpha_2$ is the expected value of the second group, so it should be the mean of the response variables with $x_2=1$.
...
$$
X^TX=\begin{bmatrix} \end{bmatrix}
$$
